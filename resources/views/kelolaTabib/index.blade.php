                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a class="btn btn-secondary" href="#" data-toggle="modal" data-target="#confirmNonaktifModal_{{ $data->id }}">
                                        <i class="fas fa-times"></i>
                                    </a>

                                    <!-- Modal konfirmasi nonaktif -->
                                    <div class="modal fade" id="confirmNonaktifModal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmNonaktifModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="confirmNonaktifModalLabel">Konfirmasi Nonaktifkan Tabib</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    Apakah Anda yakin ingin menonaktifkan tabib ini?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                    <a class="btn btn-danger" href="{{ route('tabibnonaktif', $data->id) }}">Ya, Nonaktifkan</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
