...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/contoh.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/contoh.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/contoh.jpg" alt="Third slide">
    </div>
  </div>
