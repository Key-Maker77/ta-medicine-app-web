...
<center><div class="card" style="width: 18rem; height: 8rem; margin-top: 50px; background-color: #ADD9D1; border-radius: 20px; opacity: 0.8;">
  <a href="{{ route('informasi.pengobatan', $data->id )}}" class="card-body" style="text-align: center;">
  <p style="margin-bottom: 10px;">&nbsp;</p>
    <h5 class="card-title" style="color: black;">{{ $data->nama_pengobatan }}</h5>
  </a>
</center>
@endforeach
<div style="background-color: #0087CC; position: fixed; bottom: 0; width: 100%; display: flex; justify-content: space-between; align-items: center; padding: 10px; left: 0;">
    ...
    <a href="/pengobatan"><label style="color: #0CF25D; margin-right: 10px; font-size: 25px;"><i class="fa-solid fa-pills"></i></label></a>
